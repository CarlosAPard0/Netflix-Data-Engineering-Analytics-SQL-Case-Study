...
/* Para cada director: Contar el número de películas y shows de tv creados por ellos en 
...
-- Que pais tiene la mayor cantidad de peliculas de comedia
...
-- Para cada año, que director tiene el maximo numero de peliculas
with cte as (
